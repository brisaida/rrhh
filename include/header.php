                    ...
                    <ul class="app-menu list-unstyled accordion" id="menu-accordion">
                        ...
                        <li class="nav-item has-submenu">
                            ...
                            <div id="submenu-1" class="collapse submenu submenu-1" data-bs-parent="#menu-accordion">
                                <ul class="submenu-list list-unstyled">
                                    ...
                                    <li class="submenu-item admin"><a class="submenu-link" href="?section=listadoEmpleados">Listado de Empleados</a></li>
                        ...
                        <li class="nav-item has-submenu admin">
                            ...
                            <div id="submenu-4" class="collapse submenu submenu-2" data-bs-parent="#menu-accordion">
                                <ul class="submenu-list list-unstyled">
                                    <li class="submenu-item"><a class="submenu-link" href="login.html">Autoevaluación</a></li>
                                    <li class="submenu-item"><a class="submenu-link" href="signup.html">Evaluación de desempeño</a></li>
                                </ul>
                            </div>
                        </li>
                        ...
                        <li class="nav-item has-submenu admin">
                            ...
                            <a class="nav-link submenu-toggle" href="#" data-bs-toggle="collapse" data-bs-target="#submenu-5" aria-expanded="false" aria-controls="submenu-5">
                                ...
                                <span class="nav-link-text">Reclutamiento</span>
                                <span class="submenu-arrow">
                                    <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-chevron-down" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                        <path fill-rule="evenodd" d="M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708z" />
                                    </svg>
                            ...
                            <div id="submenu-5" class="collapse submenu submenu-2" data-bs-parent="#menu-accordion">
                                <ul class="submenu-list list-unstyled">
                                    <li class="submenu-item"><a class="submenu-link" href="login.html">Candidatos</a></li>
                                    <li class="submenu-item"><a class="submenu-link" href="signup.html">Entrevistas</a></li>
                                </ul>
                            </div>
                        </li>
                        ...
                        <li class="nav-item has-submenu admin">
                            ...
                            <a class="nav-link submenu-toggle" href="#" data-bs-toggle="collapse" data-bs-target="#submenu-6" aria-expanded="false" aria-controls="submenu-6">
                                ...
                                <span class="nav-link-text">Gestión de tiempo</span>
                                <span class="submenu-arrow">
                                    <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-chevron-down" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                        <path fill-rule="evenodd" d="M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708z" />
                                    </svg>
                            ...
                            <div id="submenu-6" class="collapse submenu submenu-2" data-bs-parent="#menu-accordion">
                                <ul class="submenu-list list-unstyled">
                                    <li class="submenu-item"><a class="submenu-link" href="login.html">Entradas y salidas</a></li>
                                    <li class="submenu-item"><a class="submenu-link" href="signup.html">Carnet</a></li>
                                    <li class="submenu-item"><a class="submenu-link" href="signup.html">Control de Giras</a></li>
                                </ul>
                            </div>
                        </li>
                        ...
                        <li class="nav-item has-submenu admin">
                            ...
                            <a class="nav-link submenu-toggle" href="#" data-bs-toggle="collapse" data-bs-target="#submenu-9" aria-expanded="false" aria-controls="submenu-9">
                                ...
                                <span class="nav-link-text">Nómina</span>
                                <span class="submenu-arrow">
                                    <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-chevron-down" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                        <path fill-rule="evenodd" d="M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708z" />
                                    </svg>
                            ...
                            <div id="submenu-9" class="collapse submenu submenu-2" data-bs-parent="#menu-accordion">
                                <ul class="submenu-list list-unstyled">
                                    <li class="submenu-item"><a class="submenu-link" href="login.html">Planillas</a></li>
                                    <li class="submenu-item"><a class="submenu-link" href="signup.html">Liquidacion</a></li>
                                </ul>
                            </div>
                        </li>
                ...
                <div class="app-sidepanel-footer">
                    <nav class="app-nav app-nav-footer">
                        <ul class="app-menu footer-menu list-unstyled">
                            <li class="nav-item">
                                <a class="nav-link" href="?section=configuracion">
                                    <span class="nav-icon">
