...
$(document).ready(function () {
    ...
    //*MOSTRAR SOLICITUDES EN PROCESO
    $("#orders-aprobadoN1-tab").click(function () {
        listarMisSolicitudesEnProceso(idRegistro, 2)
    });

    //*MOSTRAR SOLICITUDES APROBADAS
    $("#orders-aprobadoN2-tab").click(function () {
        listarMisSolicitudesAprobadas(idRegistro, 3)
    });

    //*MOSTRAR SOLICITUDES CANCELADAS
    listarMisSolicitudPorAprobar(idRegistro, 1)
    $("#orders-canceladas-tab").click(function () {
        listarMisSolicitudesCanceladas(idRegistro, 4)
    });
});
                ...
                var columns = [
                    ...
                    },
                    {
                        ...
                        render: function (data, types, full, meta) {
                            /* let menu = ` <center>
                                            <a class="btn app-btn-secondary aprobar" data-id="${full.idAccionPersonal}">
                                            ...
                                            <a class="btn app-btn-secondary rechazar" data-id="${full.idAccionPersonal}">
...
function listarMisSolicitudesEnProceso(id, estado) {
    $.ajax({
        type: "POST",
        url: "./sections/accionPersonal/controller/cargarMisSolicitudesPorAprobar.php",
        data: {
        ...
        success: function (respuesta) {
            ...
            if (datos.length > 0) {
                ...
                // Llamado a la función para crear la tabla con los datos
                cargarTabla("#solicitudesN1", datos, columns);

                $('#solicitudesN1').on('click', '.aprobar', function () {
                    accionSeleccionada.id = $(this).data('id');
                    accionSeleccionada.estado = 2; // Estado para "aprobado"
                    Swal.fire({
                        title: '¿Estás seguro?',
...
function listarMisSolicitudesAprobadas(id, estado) {
    $.ajax({
        type: "POST",
        url: "./sections/accionPersonal/controller/cargarMisSolicitudesPorAprobar.php",
        data: {
            ...
            if (datos.length > 0) {
                var columns = [
                    ...
                    },
                    {
                        ...
                        width: '10%',
                        render: function (data, types, full, meta) {
                            // Convertir la fecha de regreso y la fecha actual a objetos Date
                            const fechaRegreso = new Date(full.hasta);
                            const fechaActual = new Date();

                            // Comparar las fechas
                            if (fechaRegreso > fechaActual) {
                                // Mostrar botones si la fecha de regreso es mayor que la fecha actual
                                let menu = ` <center>
                                ...
                                // No mostrar botones si la fecha de regreso no es mayor que la fecha actual
                                return '';
                            }
                        }
                    }
                ...
                // Llamado a la función para crear la tabla con los datos
                cargarTabla("#solicitudesN2", datos, columns);

                $('#solicitudesN2').on('click', '.aprobar', function () {
                    accionSeleccionada.id = $(this).data('id');
                    accionSeleccionada.estado = 2; // Estado para "aprobado"
                    Swal.fire({
                        title: '¿Estás seguro?',
...
function listarMisSolicitudesCanceladas(id, estado) {
    $.ajax({
        type: "POST",
        url: "./sections/accionPersonal/controller/cargarMisSolicitudesPorAprobar.php",
        data: {
        ...
        success: function (respuesta) {
            ...
            if (datos.length > 0) {
                ...
                // Llamado a la función para crear la tabla con los datos
                cargarTabla("#solicitudesCanceladas", datos, columns);

                $('#solicitudesCanceladas').on('click', '.aprobar', function () {
                    accionSeleccionada.id = $(this).data('id');
                    accionSeleccionada.estado = 2; // Estado para "aprobado"
                    Swal.fire({
                        title: '¿Estás seguro?',
